...
public:
	...
	double m_AverageTradingVolume10Day{ 0.0 };
	double m_PriceReturnDaily13Week{ 0.0 };
	double m_PriceReturnDaily26Week{ 0.0 };
	double m_AverageTradingVolume3Month{ 0.0 };
	double m_High52Week{ 0.0 };
	int m_HighDate52Week{ 0 };
	double m_Low52Week{ 0.0 };
	int m_LowDate52Week{ 0 };
	double m_PriceReturnDaily52Week{ 0.0 };
	double m_PriceReturnDaily5Day{ 0.0 };
