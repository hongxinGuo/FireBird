...
public:
	CSetFinnhubStockBasicFinancialQuarter(const CString& strSchema = "stock_market", const CString& strTable = "finnhub_stock_basic_financials_quarterly", CDatabase* pDatabase = nullptr);
