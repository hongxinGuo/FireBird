...
public:
	CSetInsiderTransaction(const CString& strSchema = "stock_market", const CString& strTable = "finnhub_insider_transaction", CDatabase* pDatabase = nullptr);
	~CSetInsiderTransaction() override = default;
