...
// clang-format off
// generated by C:\Program Files\sqlpp23\bin\sqlpp23-ddl2cpp --path-to-ddl C:\Users\hxguo\source\repos\FireBird\Lib\database\stock_market.sql --namespace StockMarket --path-to-header C:\Users\hxguo\source\repos\FireBird\src\StockMarketSQLTable.h
...
namespace StockMarket {
  struct AlpacaStockSymbol_ {
    ...
    SQLPP_CREATE_NAME_TAG_FOR_SQL_AND_CPP(alpaca_stock_symbol, alpacaStockSymbol);
    template<typename T>
  ...
  using AlpacaStockSymbol = ::sqlpp::table_t<AlpacaStockSymbol_>;
