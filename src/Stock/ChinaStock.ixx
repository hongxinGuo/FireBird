...
#include <queue>
export module FireBird.Stock.ChinaStock;

export import FireBird.Set.ChinaStockDayLineBasicInfo;
export import FireBird.Set.ChinaStockWeekLineBasicInfo;
...
export {
	...
	public:
		...
		// 当前被处理历史数据容器
		CVirtualContainerHistoryCandleExtend* GetDataChinaDayLine() noexcept { return &m_dataDayLine; }
		CVirtualContainerHistoryCandleExtend* GetDataChinaWeekLine() noexcept { return &m_dataWeekLine; }
