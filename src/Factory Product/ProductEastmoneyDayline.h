...
public:
	...
	// 不允许复制和赋值。
	CProductEastmoneyDayLine(const CProductEastmoneyDayLine&) = delete;
	CProductEastmoneyDayLine& operator=(const CProductEastmoneyDayLine&) = delete;
	CProductEastmoneyDayLine(const CProductEastmoneyDayLine&&) noexcept = delete;
