...
enum {
	...
	// Stock Estimates
	STOCK_ESTIMATES_RECOMMENDATION_TRENDS_ = SYMBOL_LOOKUP_ + 100,
	...
	STOCK_ESTIMATES_EBIT_ESTIMATES_ = STOCK_ESTIMATES_EBITDA_ESTIMATES_ + 1,
	...
	// ETF & Indices
	ETFS_INDICES_CONSTITUENTS_ = STOCK_PRICE_QUOTE_ + 100,
	...
	FOREX_CANDLES_ = FOREX_SYMBOLS_ + 1, // 历史数据优先级低 Premium
	...
	ALTERNATIVE_DATA_SOCIAL_SENTIMENT_ = ALTERNATIVE_DATA_TRANSCRIPT_ + 1,
	...
	ALTERNATIVE_DATA_COVID_19_ = ALTERNATIVE_DATA_VISA_APPLICATION_ + 1,
