...
enum {
	...
	// Stock Fundamentals
	SYMBOL_LOOKUP_ = WEBSOCKET_NEWS_ + 1,
	...
	// Stock Estimates
	STOCK_ESTIMATES_RECOMMENDATION_TRENDS_ = ISIN_CHANGE_ + 1, // not implemented
	...
	// Stock Price
	STOCK_PRICE_QUOTE_ = STOCK_ESTIMATES_EARNING_CALENDAR_ + 1, // 实时数据优先级最低
	...
	// ETF & Indices
	ETFS_INDICES_CONSTITUENTS_ = STOCK_PRICE_DIVIDEND2_ + 1, // Premium
	...
	// Mutual funds
	MUTUAL_FUND_PROFILE_ = ETFS_COUNTRY_ + 1, // Premium
	...
	// Bonds
	BOND_PROFILE_ = MUTUAL_FUNDS_EET_PAI_ + 1, // Premium
	...
	// Alternative Data
	ALTERNATIVE_DATA_TRANSCRIPT_LIST_ = TECHNICAL_ANALYSIS_TECHNICAL_INDICATORS_ + 1, //Premium
	...
	// Economic
	ECONOMIC_COUNTRY_LIST_ = ALTERNATIVE_DATA_FDA_CALENDAR_ + 1,
	...
	// Tiingo.com
	TIINGO_FUNDAMENTAL_DEFINITION_ = ECONOMIC_ECONOMIC_ + 1,
	TIINGO_STOCK_DAILY_META_,
	TIINGO_FINANCIAL_STATEMENT_,
	TIINGO_IEX_TOP_OF_BOOK_,

	// Accessory product
	ACCESSORY_INDEX_NASDAQ100_STOCKS_ = TIINGO_IEX_TOP_OF_BOOK_ + 1,
};
