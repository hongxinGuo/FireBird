...
[[nodiscard]] std::string jsonGetString(const json* pjs, const char* szKey, const char* szDefault = "");
...
[[nodiscard]] std::string jsonGetString(const json& js, const char* szKey, const char* szDefault = "");
...
[[nodiscard]] std::string jsonGetString(const json::iterator& it, const char* szKey, const char* szDefault = "");
