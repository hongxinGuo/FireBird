...
enum {
	...
	WORLD_MARKET_UPDATE_DB__,
	WORLD_MARKET_START_ALL_WEB_SOCKET__, // 监测各WebSocket状态
	WORLD_MARKET_STOP_ALL_WEB_SOCKET__, // 监测各WebSocket状态
	WORLD_MARKET_PROCESS_WEB_SOCKET_DATA__		// 处理各WebSocket接收到的数据
};
