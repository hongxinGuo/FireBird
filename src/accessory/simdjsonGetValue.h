...
[[nodiscard]] INT64 jsonGetInt64(ondemand::value& value, const string_view& key, INT64 defaultValue = 0);
...
[[nodiscard]] string_view jsonGetRawJsonToken(ondemand::value& value, const string_view& key);
...
[[nodiscard]] INT64 jsonGetInt64(ondemand::value& value, INT64 defaultValue = 0);
[[nodiscard]] bool jsonGetBool(ondemand::value& value);
[[nodiscard]] string_view jsonGetStringView(ondemand::value& value);
[[nodiscard]] string_view jsonGetRawJsonToken(ondemand::value& value);
...
[[nodiscard]] INT64 jsonGetInt64(ondemand::object& object, const string_view& key, INT64 defaultValue = 0);
...
[[nodiscard]] double jsonGetDouble(ondemand::document& doc, const string_view& key, double defaultValue = 0.0);
[[nodiscard]] INT64 jsonGetInt64(ondemand::document& doc, const string_view& key, INT64 defaultValue = 0);
...
[[nodiscard]] string_view jsonGetRawJsonToken(ondemand::document& doc, const string_view& key);
