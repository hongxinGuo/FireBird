...
[[nodiscard]] simdjson_result<ondemand::object> jsonGetObject(simdjson_result<ondemand::value>& value, const string_view& key);// 空数据或错误时返回一个全局空数组
...
[[nodiscard]] ondemand::array jsonGetArray(simdjson_result<ondemand::value>& value); // 空数据或错误时返回一个全局空数组
