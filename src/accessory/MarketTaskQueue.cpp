...
void CMarketTaskQueue::CreateIndexMap() {
	...
	gl_mapMarketMapIndex[WORLD_MARKET_TIINGO_INQUIRE_IEX_TOP_OF_BOOL__] = "世界市场查询Tiingo IEX实时数据";
	gl_mapMarketMapIndex[WORLD_MARKET_TIINGO_COMPILE_STOCK__] = "世界市场生成Tiingo今日日线数据";
