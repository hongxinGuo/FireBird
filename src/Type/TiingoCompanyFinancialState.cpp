...
void CTiingoCompanyFinancialState::Load(const CSetTiingoCompanyFinancialState& setTiingoFinancialState) {
	...
	m_acctRec = _tstof(setTiingoFinancialState.m_acctRec);
	m_assetsCurrent = _tstof(setTiingoFinancialState.m_assetsCurrent);
	m_assetsNonCurrent = _tstof(setTiingoFinancialState.m_assetsNonCurrent);
	m_assetTurnover = _tstof(setTiingoFinancialState.m_assetTurnover);
	m_bookVal = _tstof(setTiingoFinancialState.m_bookVal);
	m_businessAcqDisposals = _tstof(setTiingoFinancialState.m_businessAcqDisposals);
	m_bvps = _tstof(setTiingoFinancialState.m_bvps);
	m_capex = _tstof(setTiingoFinancialState.m_capex);
	m_cashAndEq = _tstof(setTiingoFinancialState.m_cashAndEq);
	m_consolidatedIncome = _tstof(setTiingoFinancialState.m_consolidatedIncome);
	m_costRev = _tstof(setTiingoFinancialState.m_costRev);
	m_currentRatio = _tstof(setTiingoFinancialState.m_currentRatio);
	m_debt = _tstof(setTiingoFinancialState.m_debt);
	m_debtCurrent = _tstof(setTiingoFinancialState.m_debtCurrent);
	m_debtEquity = _tstof(setTiingoFinancialState.m_debtEquity);
	m_debtNonCurrent = _tstof(setTiingoFinancialState.m_debtNonCurrent);
	m_deferredRev = _tstof(setTiingoFinancialState.m_deferredRev);
	m_depamor = _tstof(setTiingoFinancialState.m_depamor);
	m_deposits = _tstof(setTiingoFinancialState.m_deposits);
	m_ebit = _tstof(setTiingoFinancialState.m_ebit);
	m_ebitda = _tstof(setTiingoFinancialState.m_ebitda);
	m_ebt = _tstof(setTiingoFinancialState.m_ebt);
	m_enterpriseVal = _tstof(setTiingoFinancialState.m_enterpriseVal);
	m_eps = _tstof(setTiingoFinancialState.m_eps);
	m_epsDil = _tstof(setTiingoFinancialState.m_epsDil);
	m_epsQoQ = _tstof(setTiingoFinancialState.m_epsQoQ);
	m_equity = _tstof(setTiingoFinancialState.m_equity);
	m_freeCashFlow = _tstof(setTiingoFinancialState.m_freeCashFlow);
	m_fxRate = _tstof(setTiingoFinancialState.m_fxRate);
	m_grossMargin = _tstof(setTiingoFinancialState.m_grossMargin);
	m_grossProfit = _tstof(setTiingoFinancialState.m_grossProfit);
	m_intangibles = _tstof(setTiingoFinancialState.m_intangibles);
	m_intexp = _tstof(setTiingoFinancialState.m_intexp);
	m_inventory = _tstof(setTiingoFinancialState.m_inventory);
	m_investments = _tstof(setTiingoFinancialState.m_investments);
	m_investmentsAcqDisposals = _tstof(setTiingoFinancialState.m_investmentsAcqDisposals);
	m_investmentsCurrent = _tstof(setTiingoFinancialState.m_investmentsCurrent);
	m_investmentsNonCurrent = _tstof(setTiingoFinancialState.m_investmentsNonCurrent);
	m_issrepayDebt = _tstof(setTiingoFinancialState.m_issrepayDebt);
	m_issrepayEquity = _tstof(setTiingoFinancialState.m_issrepayEquity);
	m_liabilitiesCurrent = _tstof(setTiingoFinancialState.m_liabilitiesCurrent);
	m_liabilitiesNonCurrent = _tstof(setTiingoFinancialState.m_liabilitiesNonCurrent);
	m_longTermDebtEquity = _tstof(setTiingoFinancialState.m_longTermDebtEquity);
	m_marketCap = _tstof(setTiingoFinancialState.m_marketCap);
	m_ncf = _tstof(setTiingoFinancialState.m_ncf);
	m_ncff = _tstof(setTiingoFinancialState.m_ncff);
	m_ncfi = _tstof(setTiingoFinancialState.m_ncfi);
	m_ncfo = _tstof(setTiingoFinancialState.m_ncfo);
	m_ncfx = _tstof(setTiingoFinancialState.m_ncfx);
	m_netinc = _tstof(setTiingoFinancialState.m_netinc);
	m_netIncComStock = _tstof(setTiingoFinancialState.m_netIncComStock);
	m_netIncDiscOps = _tstof(setTiingoFinancialState.m_netIncDiscOps);
	m_netMargin = _tstof(setTiingoFinancialState.m_netMargin);
	m_nonControllingInterests = _tstof(setTiingoFinancialState.m_nonControllingInterests);
	m_opex = _tstof(setTiingoFinancialState.m_opex);
	m_opinc = _tstof(setTiingoFinancialState.m_opinc);
	m_opMargin = _tstof(setTiingoFinancialState.m_opMargin);
	m_payDiv = _tstof(setTiingoFinancialState.m_payDiv);
	m_pbRatio = _tstof(setTiingoFinancialState.m_pbRatio);
	m_peRatio = _tstof(setTiingoFinancialState.m_peRatio);
	m_piotroskiFScore = _tstof(setTiingoFinancialState.m_piotroskiFScore);
	m_ppeq = _tstof(setTiingoFinancialState.m_ppeq);
	m_prefDVDs = _tstof(setTiingoFinancialState.m_prefDVDs);
	m_profitMargin = _tstof(setTiingoFinancialState.m_profitMargin);
	m_retainedEarnings = _tstof(setTiingoFinancialState.m_retainedEarnings);
	m_revenue = _tstof(setTiingoFinancialState.m_revenue);
	m_revenueQoQ = _tstof(setTiingoFinancialState.m_revenueQoQ);
	m_rnd = _tstof(setTiingoFinancialState.m_rnd);
	m_roa = _tstof(setTiingoFinancialState.m_roa);
	m_roe = _tstof(setTiingoFinancialState.m_roe);
	m_rps = _tstof(setTiingoFinancialState.m_rps);
	m_sbcomp = _tstof(setTiingoFinancialState.m_sbcomp);
	m_sga = _tstof(setTiingoFinancialState.m_sga);
	m_shareFactor = _tstof(setTiingoFinancialState.m_shareFactor);
	m_sharesBasic = _tstof(setTiingoFinancialState.m_sharesBasic);
	m_shareswa = _tstof(setTiingoFinancialState.m_shareswa);
	m_shareswaDil = _tstof(setTiingoFinancialState.m_shareswaDil);
	m_taxAssets = _tstof(setTiingoFinancialState.m_taxAssets);
	m_taxExp = _tstof(setTiingoFinancialState.m_taxExp);
	m_taxLiabilities = _tstof(setTiingoFinancialState.m_taxLiabilities);
	m_totalAssets = _tstof(setTiingoFinancialState.m_totalAssets);
	m_totalLiabilities = _tstof(setTiingoFinancialState.m_totalLiabilities);
