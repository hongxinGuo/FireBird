...
//更新股票代码数据库线程
UINT ThreadUpdateChinaStockProfileDB(); // 此线程返回值为18
// 更新选项数据库
...
// 存储证券代码段索引
UINT ThreadSaveStockSection(); // 此工作线程返回值为35

// 下面为美国股票市场的工作线程
// 更新美股日线起止日期线程
UINT ThreadUpdateWorldMarketStockProfileDB(); // 此工作线程返回值为37
// 更新Forex日线数据
...
// 更新Crypto Exchange
UINT ThreadUpdateCryptoExchangeDB(); // 此工作线程返回值为51
// 更新Crypto代码表
...
UINT ThreadUpdateBasicFinancialDB(); // 此工作线程返回值为55
// 更新InsiderSentiment
