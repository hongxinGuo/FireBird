...
// 更新Forex代码表
UINT ThreadUpdateForexSymbolDB(const not_null<CWorldMarketPtr>& pMarket); // 此工作线程返回值为39
// 更新CountryList代码表
UINT ThreadUpdateCountryListDB(const not_null<CWorldMarketPtr>& pMarket); // 此工作线程返回值为40
// 更新EPSSurprise表
...
// 更新Economic Calender
UINT ThreadUpdateEconomicCalendarDB(const not_null<CWorldMarketPtr>& pMarket); // 此工作线程返回值为50
// 更新Crypto Exchange
UINT ThreadUpdateCryptoExchangeDB(const not_null<CWorldMarketPtr>& pMarket); // 此工作线程返回值为51
// 更新Crypto代码表
UINT ThreadUpdateFinnhubCryptoSymbolDB(const not_null<CWorldMarketPtr>& pMarket); // 此工作线程返回值为52
// 更新Crypto日线数据
