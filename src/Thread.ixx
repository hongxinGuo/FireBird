...
export class CChinaStock;
export typedef shared_ptr<CChinaStock> CChinaStockPtr;
export class CChinaMarket;
export typedef shared_ptr<CChinaMarket> CChinaMarketPtr;
