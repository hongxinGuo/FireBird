...
void CFinnhubInaccessibleExchange::DeleteExchange(int iInquireType, const string& strExchange) {
...
bool CFinnhubInaccessibleExchange::HaveExchange(int iInquireType, const string& strExchangeCode) const {
	try {
