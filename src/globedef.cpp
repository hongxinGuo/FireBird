...
CFinnhubInaccessibleExchange gl_finnhubInaccessibleExchange{ "FinnhubInaccessibleExchange.json" }; // finnhub禁止访问交易所名单（免费账户无法访问的交易所数据）。唯一实例
CTiingoInaccessibleStock gl_tiingoInaccessibleStock{ "TiingoInaccessibleStock.json" }; // tiingo禁止访问股票名单（免费账户无法访问的股票数据）。唯一实例
