...
public:
	...
	virtual void SysCallSetPaneText(int iIndex, const string& str) { m_wndStatusBar.SetPaneText(iIndex, CA2W(str.c_str())); }
	...
	virtual void SysCallSetInnerSystemPaneText(int iIndex, const string& sNewText) { m_wndInnerSystemBar.SetPaneText(iIndex, CA2W(sNewText.c_str())); }
