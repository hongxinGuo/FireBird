...
public:
	...
	virtual void SysCallSetPaneText(int iIndex, const string& str) { m_wndStatusBar.SetPaneText(iIndex, ToUTF16(str).c_str()); }
	...
	virtual void SysCallSetInnerSystemPaneText(int iIndex, const string& sNewText) { m_wndInnerSystemBar.SetPaneText(iIndex, ToUTF16(sNewText).c_str()); }
