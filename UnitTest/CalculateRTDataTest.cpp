...
namespace StockAnalysisTest {
  ...
  struct GuaDanData { // 共四十三个数据，一个序列号，二十个当前实时数据（挂单价位和数量），二十个上次实时数据（挂单价位和数量），一个成交类型，一个成交价格
    GuaDanData(int count, int type, double price,
      ...
      CurrentData.m_lPBuy[4] = dS5; CurrentData.m_lVBuy[4] = lS5;
      CurrentData.m_lPBuy[3] = dS4; CurrentData.m_lVBuy[3] = lS4;
      CurrentData.m_lPBuy[2] = dS3; CurrentData.m_lVBuy[2] = lS3;
      CurrentData.m_lPBuy[1] = dS2; CurrentData.m_lVBuy[1] = lS2;
      CurrentData.m_lPBuy[0] = dS1; CurrentData.m_lVBuy[0] = lS1;

      LastData.m_lPSell[4] = dS5; LastData.m_lVSell[4] = lS5;
      LastData.m_lPSell[3] = dS4; LastData.m_lVSell[3] = lS4;
      LastData.m_lPSell[2] = dS3; LastData.m_lVSell[2] = lS3;
      LastData.m_lPSell[1] = dS2; LastData.m_lVSell[1] = lS2;
      LastData.m_lPSell[0] = dS1; LastData.m_lVSell[0] = lS1;
      LastData.m_lPBuy[4] = dS5; LastData.m_lVBuy[4] = lS5;
      LastData.m_lPBuy[3] = dS4; LastData.m_lVBuy[3] = lS4;
      LastData.m_lPBuy[2] = dS3; LastData.m_lVBuy[2] = lS3;
      LastData.m_lPBuy[1] = dS2; LastData.m_lVBuy[1] = lS2;
      LastData.m_lPBuy[0] = dS1; LastData.m_lVBuy[0] = lS1;
    }
  ...
  INSTANTIATE_TEST_CASE_P(TestGuaDanData, RTDataGuaDanTest, testing::Values(&GuaDan1));
