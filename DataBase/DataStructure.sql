...
--
-- Current Database: `smartstockdata`
--

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `smartstockdata` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
...
) ENGINE=InnoDB AUTO_INCREMENT=12744751 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `daylineinfo` (
  ...
  KEY `STOCKCODE` (`StockCode`,`Day`),
  KEY `TIME` (`Day`)
) ENGINE=InnoDB AUTO_INCREMENT=650251 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `stockcode` (
  ...
  `StockName` varchar(12) DEFAULT ' ',
  `DayLineStartDay` int(10) DEFAULT '29900101',
  `DayLineEndDay` int(10) DEFAULT '19900101',
  `IPOed` int(10) DEFAULT '128',
  PRIMARY KEY (`ID`),
  UNIQUE KEY `ID_UNIQUE` (`ID`),
  KEY `STOCKCODE` (`StockCode`)
) ENGINE=InnoDB AUTO_INCREMENT=2894274 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `today` (
  ...
  UNIQUE KEY `Id_UNIQUE` (`Id`),
  KEY `time` (`Day`)
) ENGINE=InnoDB AUTO_INCREMENT=6564105 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Current Database: `teststock`
--

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `teststock` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
...
CREATE TABLE `dayline` (
  ...
  KEY `TIME` (`Day`,`UpDownRate`),
  KEY `STOCKCODE` (`StockCode`,`Day`)
) ENGINE=InnoDB AUTO_INCREMENT=12681255 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `daylineinfo` (
  ...
  KEY `STOCKCODE` (`StockCode`,`Day`),
  KEY `TIME` (`Day`)
) ENGINE=InnoDB AUTO_INCREMENT=585372 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `stockcode` (
  ...
  UNIQUE KEY `ID_UNIQUE` (`ID`),
  KEY `STOCKCODE` (`StockCode`)
) ENGINE=InnoDB AUTO_INCREMENT=480001 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `today` (
  ...
  UNIQUE KEY `Id_UNIQUE` (`Id`),
  KEY `time` (`Day`)
) ENGINE=InnoDB AUTO_INCREMENT=3230840 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2019-12-27  8:42:35
