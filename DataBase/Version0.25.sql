...
) ENGINE=InnoDB AUTO_INCREMENT=894704 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `finnhub_stock_basic_financials_metric` (
  ...
  UNIQUE KEY `ID_UNIQUE` (`ID`),
  KEY `Symbol` (`Symbol`)
) ENGINE=InnoDB AUTO_INCREMENT=8352 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `finnhub_stock_basic_financials_quarterly` (
  ...
  UNIQUE KEY `ID_UNIQUE` (`ID`),
  KEY `Symbol` (`Symbol`,`Type`)
) ENGINE=InnoDB AUTO_INCREMENT=2875098 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `tiingo_supported_tickers`
--

DROP TABLE IF EXISTS `tiingo_supported_tickers`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `tiingo_supported_tickers` (
  `ID` int NOT NULL AUTO_INCREMENT,
  `ticker` text,
  `exchange` text,
  `assetType` text,
  ...
  `endDate` text,
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB AUTO_INCREMENT=101257 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2022-05-12  5:46:38
-- MySQL dump 10.13  Distrib 8.0.29, for Win64 (x86_64)
--
...
CREATE TABLE `crweberindex` (
  ...
  KEY `time` (`Date`)
) ENGINE=InnoDB AUTO_INCREMENT=1571575 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `dayline` (
  ...
  KEY `Day` (`Date`,`Symbol`)
) ENGINE=InnoDB AUTO_INCREMENT=14257860 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `option_calculatingrs` (
  ...
  KEY `Index` (`Index`)
) ENGINE=InnoDB AUTO_INCREMENT=21321 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `choiced_stock` (
  ...
  PRIMARY KEY (`ID`),
  KEY `Symbol` (`Symbol`) /*!80000 INVISIBLE */
) ENGINE=InnoDB AUTO_INCREMENT=7757 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `crweberindex` (
  ...
  KEY `CPP_USGCBS` (`CPP_USGCBS`),
  KEY `time` (`Date`)
) ENGINE=InnoDB AUTO_INCREMENT=4009510 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `currentweekline` (
  ...
  `CanceledSellAbove200000` decimal(15,0) DEFAULT '0',
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB AUTO_INCREMENT=617385 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='此表用于存储当前周的周线数据（所有的周数据皆位于此表中）,与today表使用相同的数据。';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `dayline` (
  ...
  KEY `STOCKCODE` (`Symbol`,`Date`),
  KEY `Day` (`Date`,`Symbol`)
) ENGINE=InnoDB AUTO_INCREMENT=13237531 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `daylineinfo` (
  ...
  KEY `STOCKCODE` (`Symbol`,`Date`),
  KEY `TIME` (`Date`)
) ENGINE=InnoDB AUTO_INCREMENT=14406180 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `option_calculatingrs` (
  ...
  UNIQUE KEY `Index_UNIQUE` (`Index`),
  KEY `Index` (`Index`)
) ENGINE=InnoDB AUTO_INCREMENT=41002 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `potendailybriefing` (
  ...
  KEY `ID` (`Id`) /*!80000 INVISIBLE */,
  KEY `Day` (`Date`)
) ENGINE=InnoDB AUTO_INCREMENT=2798 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Poten Daily Briefing for shipping Index.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `realtimedata` (
  ...
  KEY `StockCode` (`Symbol`),
  KEY `Time` (`Time`)
) ENGINE=InnoDB AUTO_INCREMENT=5649 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `today` (
  ...
  UNIQUE KEY `Id_UNIQUE` (`Id`),
  KEY `time` (`Date`)
) ENGINE=InnoDB AUTO_INCREMENT=7241 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='与CurrentWeekLine表使用相同的数据。';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `weekline` (
  ...
  KEY `DAY` (`Date`,`Symbol`),
  KEY `Symbol` (`Symbol`,`Date`)
) ENGINE=InnoDB AUTO_INCREMENT=2877573 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `weeklineinfo` (
  ...
  KEY `STOCKCODE` (`Symbol`,`Date`),
  KEY `TIME` (`Date`,`Symbol`)
) ENGINE=InnoDB AUTO_INCREMENT=2871948 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
/*!40103 SET TIME_ZONE=@OLD_TIME_ZONE */;
...
CREATE TABLE `crypto_dayline` (
  ...
  KEY `Symbol` (`Symbol`,`Date`) /*!80000 INVISIBLE */,
  KEY `Date` (`Symbol`,`Date`)
) ENGINE=InnoDB AUTO_INCREMENT=2976172 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `finnhub_crypto_symbol` (
  ...
  UNIQUE KEY `ID_UNIQUE` (`ID`) /*!80000 INVISIBLE */,
  KEY `Symbol` (`Symbol`)
) ENGINE=InnoDB AUTO_INCREMENT=9340 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=5104943 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `finnhub_stock_basic_financials_metric` (
  ...
  UNIQUE KEY `ID_UNIQUE` (`ID`),
  KEY `Symbol` (`Symbol`)
) ENGINE=InnoDB AUTO_INCREMENT=34943 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `finnhub_stock_basic_financials_quarterly` (
  ...
  UNIQUE KEY `ID_UNIQUE` (`ID`),
  KEY `Symbol` (`Symbol`,`Date`)
) ENGINE=InnoDB AUTO_INCREMENT=15752670 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `insider_transaction` (
  ...
  KEY `PersonName` (`PersonName`),
  KEY `TransactionCode` (`TransactionCode`)
) ENGINE=InnoDB AUTO_INCREMENT=434873 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `stock_dayline` (
  ...
  KEY `Date` (`Date`,`Symbol`),
  KEY `Symbol` (`Symbol`)
) ENGINE=InnoDB AUTO_INCREMENT=14097432 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `stock_profile` (
  ...
  `Peer` varchar(200) DEFAULT ' ',
  `ProfileUpdateDate` int DEFAULT '19800101',
  `BasicFinancialUpdateDate` int DEFAULT '19800101',
  `DayLineStartDate` int DEFAULT '29900101',
  `DayLineEndDate` int DEFAULT '19800101',
  `LastRTDataUpdateDate` int DEFAULT '19800101',
  `PeerUpdateDate` int DEFAULT '19800101',
  ...
  KEY `LastRTUpdatedDate` (`LastRTDataUpdateDate`),
  KEY `Symbol` (`Symbol`,`ID`)
) ENGINE=InnoDB AUTO_INCREMENT=34961 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='所有股票的基本情况。';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `tiingo_crypto_symbol` (
  ...
  KEY `QuoteCurrency` (`QuoteCurrency`) /*!80000 INVISIBLE */,
  KEY `Ticker` (`Ticker`)
) ENGINE=InnoDB AUTO_INCREMENT=8225 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='tiingo crypto代码';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `tiingo_stock_fundanmental` (
  ...
  `DailyDataUpdateDate` int DEFAULT '19800101',
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB AUTO_INCREMENT=57688 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `crweberindex` (
  ...
  KEY `CPP_USGCBS` (`CPP_USGCBS`),
  KEY `time` (`Date`)
) ENGINE=InnoDB AUTO_INCREMENT=1964915 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `currentweekline` (
  ...
  `CanceledSellAbove200000` decimal(15,0) DEFAULT '0',
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB AUTO_INCREMENT=2033403 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='此表用于存储当前周的周线数据（所有的周数据皆位于此表中）';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `dayline` (
  ...
  KEY `STOCKCODE` (`Symbol`,`Date`),
  KEY `Date` (`Date`,`Symbol`)
) ENGINE=InnoDB AUTO_INCREMENT=15289467 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `daylineinfo` (
  ...
  KEY `STOCKCODE` (`Symbol`,`Date`),
  KEY `TIME` (`Date`)
) ENGINE=InnoDB AUTO_INCREMENT=15836603 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `option_calculatingrs` (
  ...
  UNIQUE KEY `Index_UNIQUE` (`Index`),
  KEY `Index` (`Index`)
) ENGINE=InnoDB AUTO_INCREMENT=34281 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `stockcode` (
  ...
  PRIMARY KEY (`ID`),
  UNIQUE KEY `ID_UNIQUE` (`ID`,`Symbol`)
) ENGINE=InnoDB AUTO_INCREMENT=9832 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `weekline` (
  ...
  KEY `DAY` (`Date`,`Symbol`),
  KEY `Symbol` (`Symbol`,`Date`)
) ENGINE=InnoDB AUTO_INCREMENT=4238094 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `weeklineinfo` (
  ...
  KEY `STOCKCODE` (`Symbol`,`Date`),
  KEY `TIME` (`Date`,`Symbol`)
) ENGINE=InnoDB AUTO_INCREMENT=4233097 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
/*!40103 SET TIME_ZONE=@OLD_TIME_ZONE */;
...
-- Dump completed on 2022-05-12  5:46:39
-- MySQL dump 10.13  Distrib 8.0.29, for Win64 (x86_64)
--
...
CREATE TABLE `crypto_dayline` (
  ...
  UNIQUE KEY `ID_UNIQUE` (`ID`),
  KEY `Date` (`Symbol`,`Date`),
  KEY `Symbol` (`Date`,`Symbol`)
) ENGINE=InnoDB AUTO_INCREMENT=1613535 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `economic_calendar` (
  ...
  PRIMARY KEY (`ID`),
  UNIQUE KEY `ID_UNIQUE` (`ID`)
) ENGINE=InnoDB AUTO_INCREMENT=5765 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `eps_surprise` (
  ...
  KEY `Symbol` (`Symbol`),
  KEY `Date` (`Date`)
) ENGINE=InnoDB AUTO_INCREMENT=109911 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `finnhub_crypto_symbol` (
  ...
  UNIQUE KEY `ID_UNIQUE` (`ID`) /*!80000 INVISIBLE */,
  KEY `Symbol` (`Symbol`)
) ENGINE=InnoDB AUTO_INCREMENT=11848 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `finnhub_forex_symbol` (
  ...
  UNIQUE KEY `ID_UNIQUE` (`ID`),
  KEY `Symbol` (`Symbol`)
) ENGINE=InnoDB AUTO_INCREMENT=10609 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `finnhub_stock_basic_financials_annual` (
  ...
  UNIQUE KEY `ID_UNIQUE` (`ID`),
  KEY `Symbol` (`Symbol`,`Date`,`Type`)
) ENGINE=InnoDB AUTO_INCREMENT=899131 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `finnhub_stock_basic_financials_metric` (
  ...
  UNIQUE KEY `ID_UNIQUE` (`ID`),
  KEY `Symbol` (`Symbol`)
) ENGINE=InnoDB AUTO_INCREMENT=8471 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `finnhub_stock_basic_financials_quarterly` (
  ...
  PRIMARY KEY (`ID`),
  UNIQUE KEY `ID_UNIQUE` (`ID`),
  KEY `Symbol` (`Symbol`,`Type`,`Date`)
) ENGINE=InnoDB AUTO_INCREMENT=2879550 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `finnhub_stock_exchange` (
  ...
  `Source` varchar(100) DEFAULT '',
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB AUTO_INCREMENT=3263 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `forex_dayline` (
  ...
  KEY `Symbol` (`Symbol`,`Date`),
  KEY `Date` (`Date`)
) ENGINE=InnoDB AUTO_INCREMENT=232707 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `insider_transaction` (
  ...
  KEY `PersonName` (`PersonName`),
  KEY `TransactionCode` (`TransactionCode`)
) ENGINE=InnoDB AUTO_INCREMENT=24393 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `naics_industry` (
  ...
  KEY `NAICS` (`Naics`) /*!80000 INVISIBLE */,
  KEY `Industry` (`NationalIndustry`,`Sector`,`SubSector`)
) ENGINE=InnoDB AUTO_INCREMENT=3183 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='NAICS行业标准';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `sic_industry` (
  ...
  KEY `SICCode` (`Code`) /*!80000 INVISIBLE */,
  KEY `Industry` (`Industry`,`Sector`)
) ENGINE=InnoDB AUTO_INCREMENT=3174 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='SIC行业标准';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `stock_dayline` (
  ...
  KEY `Symbol` (`Symbol`),
  KEY `Date` (`Date`,`Symbol`)
) ENGINE=InnoDB AUTO_INCREMENT=9036660 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `stock_profile` (
  ...
  KEY `LastRTUpdatedDate` (`LastRTDataUpdateDate`),
  KEY `Symbol` (`Symbol`,`ID`)
) ENGINE=InnoDB AUTO_INCREMENT=307017 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `tiingo_crypto_symbol` (
  ...
  KEY `QuoteCurrency` (`QuoteCurrency`) /*!80000 INVISIBLE */,
  KEY `Ticker` (`Ticker`)
) ENGINE=InnoDB AUTO_INCREMENT=16443 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='tiingo crypto代码';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `tiingo_industry` (
  ...
  PRIMARY KEY (`ID`),
  KEY `Industry` (`Industry`,`Sector`)
) ENGINE=InnoDB AUTO_INCREMENT=3177 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `tiingo_stock_fundanmental` (
  ...
  PRIMARY KEY (`ID`),
  KEY `Ticker` (`Ticker`)
) ENGINE=InnoDB AUTO_INCREMENT=59582 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
