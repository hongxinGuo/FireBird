CREATE DATABASE  IF NOT EXISTS `chinamarket_realtime_test` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `chinamarket_realtime_test`;
...
-- Dump completed on 2022-02-03 18:46:40
CREATE DATABASE  IF NOT EXISTS `chinamarket_test` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `chinamarket_test`;
-- MySQL dump 10.13  Distrib 8.0.28, for Win64 (x86_64)
--
...
) ENGINE=InnoDB AUTO_INCREMENT=5357 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `crweberindex` (
  ...
  KEY `CPP_USGCBS` (`CPP_USGCBS`),
  KEY `time` (`Date`)
) ENGINE=InnoDB AUTO_INCREMENT=3764564 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `currentweekline` (
  ...
  `CanceledSellAbove200000` decimal(15,0) DEFAULT '0',
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB AUTO_INCREMENT=616172 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='此表用于存储当前周的周线数据（所有的周数据皆位于此表中）,与today表使用相同的数据。';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `dayline` (
  ...
  KEY `STOCKCODE` (`Symbol`,`Date`),
  KEY `Day` (`Date`,`Symbol`)
) ENGINE=InnoDB AUTO_INCREMENT=13220322 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `daylineinfo` (
  ...
  KEY `STOCKCODE` (`Symbol`,`Date`),
  KEY `TIME` (`Date`)
) ENGINE=InnoDB AUTO_INCREMENT=14404338 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `option_calculatingrs` (
  ...
  UNIQUE KEY `Index_UNIQUE` (`Index`),
  KEY `Index` (`Index`)
) ENGINE=InnoDB AUTO_INCREMENT=35892 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `potendailybriefing` (
  ...
  KEY `ID` (`Id`) /*!80000 INVISIBLE */,
  KEY `Day` (`Date`)
) ENGINE=InnoDB AUTO_INCREMENT=2651 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Poten Daily Briefing for shipping Index.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `realtimedata` (
  ...
  KEY `StockCode` (`Symbol`),
  KEY `Time` (`Time`)
) ENGINE=InnoDB AUTO_INCREMENT=4407 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `stockcode` (
  ...
  PRIMARY KEY (`ID`),
  UNIQUE KEY `ID_UNIQUE` (`ID`,`Symbol`)
) ENGINE=InnoDB AUTO_INCREMENT=9419 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `today` (
  ...
  UNIQUE KEY `Id_UNIQUE` (`Id`),
  KEY `time` (`Date`)
) ENGINE=InnoDB AUTO_INCREMENT=6623 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='与CurrentWeekLine表使用相同的数据。';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `weekline` (
  ...
  KEY `DAY` (`Date`,`Symbol`),
  KEY `Symbol` (`Symbol`,`Date`)
) ENGINE=InnoDB AUTO_INCREMENT=2862844 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `weeklineinfo` (
  ...
  KEY `STOCKCODE` (`Symbol`,`Date`),
  KEY `TIME` (`Date`,`Symbol`)
) ENGINE=InnoDB AUTO_INCREMENT=2858445 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
/*!40103 SET TIME_ZONE=@OLD_TIME_ZONE */;
...
-- Dump completed on 2022-02-03 18:46:40
CREATE DATABASE  IF NOT EXISTS `chinamarket` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `chinamarket`;
-- MySQL dump 10.13  Distrib 8.0.28, for Win64 (x86_64)
--
...
CREATE TABLE `crweberindex` (
  ...
  KEY `CPP_USGCBS` (`CPP_USGCBS`),
  KEY `time` (`Date`)
) ENGINE=InnoDB AUTO_INCREMENT=1878768 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `currentweekline` (
  ...
  `CanceledSellAbove200000` decimal(15,0) DEFAULT '0',
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB AUTO_INCREMENT=1708726 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='此表用于存储当前周的周线数据（所有的周数据皆位于此表中）';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=14930051 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `daylineinfo` (
  ...
  KEY `STOCKCODE` (`Symbol`,`Date`),
  KEY `TIME` (`Date`)
) ENGINE=InnoDB AUTO_INCREMENT=15499005 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `option_calculatingrs` (
  ...
  UNIQUE KEY `Index_UNIQUE` (`Index`),
  KEY `Index` (`Index`)
) ENGINE=InnoDB AUTO_INCREMENT=25971 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `stockcode` (
  ...
  PRIMARY KEY (`ID`),
  UNIQUE KEY `ID_UNIQUE` (`ID`,`Symbol`)
) ENGINE=InnoDB AUTO_INCREMENT=5449 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `weekline` (
  ...
  KEY `DAY` (`Date`,`Symbol`),
  KEY `Symbol` (`Symbol`,`Date`)
) ENGINE=InnoDB AUTO_INCREMENT=3908420 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2022-02-03 18:46:40
CREATE DATABASE  IF NOT EXISTS `worlmarket_realtime_test` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `worlmarket_realtime_test`;
-- MySQL dump 10.13  Distrib 8.0.28, for Win64 (x86_64)
--
-- Host: localhost    Database: worlmarket_realtime_test
-- ------------------------------------------------------
-- Server version	8.0.28
...
-- Dump completed on 2022-02-03 18:46:40
CREATE DATABASE  IF NOT EXISTS `worldmarket` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `worldmarket`;
-- MySQL dump 10.13  Distrib 8.0.28, for Win64 (x86_64)
--
...
CREATE TABLE `insider_transaction` (
  ...
  KEY `PersonName` (`PersonName`),
  KEY `TransactionCode` (`TransactionCode`)
) ENGINE=InnoDB AUTO_INCREMENT=313463 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `stock_dayline` (
  ...
  KEY `Date` (`Date`,`Symbol`) /*!80000 INVISIBLE */,
  KEY `Symbol` (`Symbol`)
) ENGINE=InnoDB AUTO_INCREMENT=13380591 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `stock_profile` (
  ...
  KEY `LastRTUpdatedDate` (`LastRTDataUpdateDate`),
  KEY `Symbol` (`Symbol`,`ID`)
) ENGINE=InnoDB AUTO_INCREMENT=356011 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='所有股票的基本情况。';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `tiingo_crypto_symbol` (
  ...
  KEY `QuoteCurrency` (`QuoteCurrency`) /*!80000 INVISIBLE */,
  KEY `Ticker` (`Ticker`)
) ENGINE=InnoDB AUTO_INCREMENT=4997 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='tiingo crypto代码';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2022-02-03 18:46:40
CREATE DATABASE  IF NOT EXISTS `worldmarket_test` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `worldmarket_test`;
-- MySQL dump 10.13  Distrib 8.0.28, for Win64 (x86_64)
--
...
CREATE TABLE `country_list` (
  ...
  KEY `Code` (`Code2`) /*!80000 INVISIBLE */,
  KEY `CurrencyCode` (`CurrencyCode`)
) ENGINE=InnoDB AUTO_INCREMENT=5620 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `crypto_dayline` (
  ...
  UNIQUE KEY `ID_UNIQUE` (`ID`),
  KEY `Date` (`Symbol`,`Date`),
  KEY `Symbol` (`Date`,`Symbol`) /*!80000 INVISIBLE */
) ENGINE=InnoDB AUTO_INCREMENT=1612309 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `economic_calendar` (
  ...
  PRIMARY KEY (`ID`),
  UNIQUE KEY `ID_UNIQUE` (`ID`)
) ENGINE=InnoDB AUTO_INCREMENT=4526 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `eps_surprise` (
  ...
  KEY `Symbol` (`Symbol`),
  KEY `Date` (`Date`)
) ENGINE=InnoDB AUTO_INCREMENT=108653 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `finnhub_forex_symbol` (
  ...
  UNIQUE KEY `ID_UNIQUE` (`ID`),
  KEY `Symbol` (`Symbol`)
) ENGINE=InnoDB AUTO_INCREMENT=8788 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `forex_dayline` (
  ...
  KEY `Symbol` (`Symbol`,`Date`),
  KEY `Date` (`Date`)
) ENGINE=InnoDB AUTO_INCREMENT=231507 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `insider_transaction` (
  ...
  KEY `PersonName` (`PersonName`),
  KEY `TransactionCode` (`TransactionCode`)
) ENGINE=InnoDB AUTO_INCREMENT=18788 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `naics_industry` (
  ...
  KEY `NAICS` (`Naics`) /*!80000 INVISIBLE */,
  KEY `Industry` (`NationalIndustry`,`Sector`,`SubSector`)
) ENGINE=InnoDB AUTO_INCREMENT=2557 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='NAICS行业标准';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `sic_industry` (
  ...
  KEY `SICCode` (`Code`) /*!80000 INVISIBLE */,
  KEY `Industry` (`Industry`,`Sector`)
) ENGINE=InnoDB AUTO_INCREMENT=2557 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='SIC行业标准';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `stock_dayline` (
  ...
  KEY `Symbol` (`Symbol`,`Date`)
) ENGINE=InnoDB AUTO_INCREMENT=9032319 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `stock_profile` (
  ...
  KEY `LastRTUpdatedDate` (`LastRTDataUpdateDate`),
  KEY `Symbol` (`Symbol`,`ID`)
) ENGINE=InnoDB AUTO_INCREMENT=305769 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `tiingo_crypto_symbol` (
  ...
  KEY `QuoteCurrency` (`QuoteCurrency`) /*!80000 INVISIBLE */,
  KEY `Ticker` (`Ticker`)
) ENGINE=InnoDB AUTO_INCREMENT=15172 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='tiingo crypto代码';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `tiingo_industry` (
  ...
  PRIMARY KEY (`ID`),
  KEY `Industry` (`Industry`,`Sector`)
) ENGINE=InnoDB AUTO_INCREMENT=2554 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `tiingo_stock_fundanmental` (
  ...
  PRIMARY KEY (`ID`),
  KEY `Ticker` (`Ticker`)
) ENGINE=InnoDB AUTO_INCREMENT=58341 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2022-02-03 18:46:41
