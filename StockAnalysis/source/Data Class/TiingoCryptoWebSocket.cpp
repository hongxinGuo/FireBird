...
void FunctionProcessTiingoCryptoWebSocket(const ix::WebSocketMessagePtr& msg) {
	...
	case ix::WebSocketMessageType::Open:
		gl_systemMessage.PushInnerSystemInformationMessage(_T("Tiingo Crypto WebSocket Open"));
		break;
	case ix::WebSocketMessageType::Close:
		gl_systemMessage.PushInnerSystemInformationMessage(_T("Tiingo Crypto WebSocket Close"));
		break;
