...
bool CProductFinnhubEconomicCountryList::ParseAndStoreWebData(CWebDataPtr pWebData, CVirtualDataSource* pDataSource) {
...
CCountryVectorPtr CProductFinnhubEconomicCountryList::ParseFinnhubCountryList(CWebDataPtr pWebData) {
	...
	if (pWebData->CheckNoRightToAccess()) { m_iReceivedDataStatus = __NO_ACCESS_RIGHT__; return pvCountry; }
