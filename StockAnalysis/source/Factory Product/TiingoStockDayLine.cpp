...
IMPLEMENT_DYNCREATE(CTiingoStockDayLine, CWebSourceDataProduct)

CTiingoStockDayLine::CTiingoStockDayLine() : CWebSourceDataProduct() {
	m_strClassName = _T("Tiingo stock price candle");
	m_strInquiringStr = _T("https://api.tiingo.com/tiingo/daily/");
	m_lIndex = -1;
}

CString CTiingoStockDayLine::CreatMessage(void) {
...
bool CTiingoStockDayLine::ProcessWebData(CWebDataPtr pWebData) {
	ASSERT(m_lIndex >= 0);
	ASSERT(m_pMarket->IsKindOf(RUNTIME_CLASS(CWorldMarket)));
...
//
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
CDayLineVectorPtr CTiingoStockDayLine::ParseTiingoStockDayLine(CWebDataPtr pWebData) {
