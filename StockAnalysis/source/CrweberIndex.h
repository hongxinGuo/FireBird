...
public:
  ...
  double GetVLCC_1YEAR(void) { return m_dVLCC_TC_1YEAR; }
  double GetSUEZMAX_1YEAR(void) { return m_dSUEZMAX_TC_1YEAR; }
  double GetAFRAMAX_1YEAR(void) { return m_dAFRAMAX_TC_1YEAR; }
  double GetMR_1YEAR(void) { return m_dMR_TC_1YEAR; }
  double GetHANDY_1YEAR(void) { return m_dHANDY_TC_1YEAR; }
  double GetVLCC_3YEAR(void) { return m_dVLCC_TC_3YEAR; }
  double GetSUEZMAX_3YEAR(void) { return m_dSUEZMAX_TC_3YEAR; }
  double GetAFRAMAX_3YEAR(void) { return m_dAFRAMAX_TC_3YEAR; }
  double GetMR_3YEAR(void) { return m_dMR_TC_3YEAR; }
  double GetHANDY_3YEAR(void) { return m_dHANDY_TC_3YEAR; }
