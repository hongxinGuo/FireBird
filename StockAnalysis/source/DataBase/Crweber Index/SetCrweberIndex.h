...
class CSetCrweberIndex : public CVirtualRecordset
{
public:
	CSetCrweberIndex(CString strSchema = _T("ChinaMarket"), CString strTable = _T("crweberIndex"), CDatabase* pDatabase = nullptr);
