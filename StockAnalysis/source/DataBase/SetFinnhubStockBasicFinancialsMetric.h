...
//
///
class CSetFinnhubStockBasicFinancialsMetric : public CVirtualRecordset
{
public:
	CSetFinnhubStockBasicFinancialsMetric(CString strSchema = _T("WorldMarket"), CString strTable = _T("finnhub_stock_basic_financials_metric"), CDatabase* pDatabase = nullptr);
	DECLARE_DYNAMIC(CSetFinnhubStockBasicFinancialsMetric)
