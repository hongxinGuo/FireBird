...
IMPLEMENT_DYNAMIC(CSetWeekLineExtendInfo, CRecordset)

CSetWeekLineExtendInfo::CSetWeekLineExtendInfo(CDatabase* pdb)
  : CRecordset(pdb) {
  m_ID = 0;
  m_Day = 0;
  m_Market = 0;
...
CString CSetWeekLineExtendInfo::GetDefaultSQL() {
  return _T("[WeekLineInfo]");
}
