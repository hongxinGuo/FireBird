...
class CSetPotenDailyBriefing : public CVirtualRecordset
{
public:
	CSetPotenDailyBriefing(CString strSchema = _T("ChinaMarket"), CString strTable = _T("potendailybriefing"), CDatabase* pDatabase = nullptr);
