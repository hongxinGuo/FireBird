...
IMPLEMENT_DYNAMIC(CSetPotenDailyBriefing, CVirtualRecordset)

CSetPotenDailyBriefing::CSetPotenDailyBriefing(CString strSchema, CString strTable, CDatabase* pdb)
