...
public:
  ...
  void SetLastClose(char* buffer) noexcept { m_lLastClose = GetValue(buffer); }
  void SetLastClose(long lValue) noexcept { m_lLastClose = lValue; }
  long GetOpen(void) noexcept { return m_lOpen; }
  void SetOpen(char* buffer) noexcept { m_lOpen = GetValue(buffer); }
  ...
  void SetUpDown(char* buffer) noexcept { m_dUpDown = GetValue(buffer); }
  void SetUpDown(double dValue) noexcept { m_dUpDown = dValue; }
  double GetUpDownRate(void) noexcept { return m_dUpDownRate; }
  void SetUpDownRate(char* buffer) noexcept { m_dUpDownRate = GetValue(buffer); }
  ...
  void SetChangeHandRate(char* buffer) noexcept { m_dChangeHandRate = GetValue(buffer); }
  ...
  void SetTotalValue(char* buffer) noexcept { m_llTotalValue = GetValue(buffer); }
  ...
  void SetCurrentValue(char* buffer) noexcept { m_llCurrentValue = GetValue(buffer); }
