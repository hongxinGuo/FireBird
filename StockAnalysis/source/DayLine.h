...
public:
	...
	bool SaveCryptoDayLine(not_null<CSetCryptoDayLine*> pSetCryptoDayLine);
	bool AppendCryptoDayLine(not_null<CSetCryptoDayLine*> pSetCryptoDayLine);
	bool LoadCryptoDayLine(not_null<CSetCryptoDayLine*> pSetCryptoDayLine);
