...
// 更新Forex日线数据
UINT ThreadUpdateForexDayLineDB(not_null<CForexSymbol*> pSymbol); // 此工作线程的返回值未38
// 更新Forex代码表
...
// 更新Crypto代码表
UINT ThreadUpdateCryptoSymbolDB(not_null<CWorldMarket*> pMarket); // 此工作线程返回值为52
// 更新Crypto日线数据
UINT ThreadUpdateCryptoDayLineDB(not_null<CFinnhubCryptoSymbol*> pSymbol); // 此工作线程的返回值未53
// 更新Tiingo crypto代码集。
UINT ThreadUpdateTiingoCryptoDB(not_null<CWorldMarket*> pMarket); // 此工作线程返回值为54
