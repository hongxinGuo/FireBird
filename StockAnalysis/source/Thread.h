...
// 更新Forex代码表
UINT ThreadUpdateForexSymbolDB(not_null<CAmericaStakeMarket*> pMarket); // 此工作线程返回值为39
// 更新CountryList代码表
UINT ThreadUpdateCountryListDB(not_null<CAmericaStakeMarket*> pMarket); // 此工作线程返回值为40
