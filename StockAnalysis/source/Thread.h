...
UINT ThreadCalculateThisDayRS(LPVOID pParam); // 此工作线程返回值也为9
...
// 维护日线数据库线程（尚未实现）
UINT ThreadMaintainDayLineDataBase(LPVOID pParam);   // 此工作线程返回值为11

//更新股票代码数据库线程
UINT ThreadUpdateStockCodeDB(LPVOID pParam); // 此线程返回值为14