...
CWeekLine::CWeekLine() : CObject() {
  Reset();
}

bool CWeekLine::LoadEntendData(CSetWeekLineExtendInfo& setWeekLineExtendInfo) {
...
void CWeekLine::CalculateRSLogarithm(double dRS) {
...
void CWeekLine::Reset(void) {
  ...
  m_d3WeekRS = m_d5WeekRS = m_d10WeekRS = m_d30WeekRS = m_d60WeekRS = m_d120WeekRS = 0.0;
...
bool CWeekLine::SaveData(CSetWeekLineBasicInfo& setWeekLineBasicInfo) {
...
bool CWeekLine::AppendData(CSetWeekLineBasicInfo& setWeekLineBasicInfo) {
  ASSERT(setWeekLineBasicInfo.IsOpen());
...
bool CWeekLine::LoadBasicData(CSetWeekLineBasicInfo& setWeekLineBasicInfo) {
  ASSERT(setWeekLineBasicInfo.IsOpen());
