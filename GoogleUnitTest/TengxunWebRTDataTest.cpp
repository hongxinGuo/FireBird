...
namespace FireBirdTest {
	...
	TEST_P(ReadTengxunOneValueTest, TestReadTengxunOneValue3) {
		...
		case 6:
		case 10:
			EXPECT_THROW(fSucceed = m_RTData.ReadTengxunOneValue(m_pTengxunWebRTData, buffer), exception);
			fSucceed = false;
			bHaveException = true;
			break;
		default:
			EXPECT_NO_THROW(fSucceed = m_RTData.ReadTengxunOneValue(m_pTengxunWebRTData, buffer));
			break;
		}
