...
namespace StockAnalysisTest {
	...
	TEST_F(CThreadReadNeteaseRTDataTest, TestThreadReadNeteaseRTData1) {
		...
		NeteaseRTWebInquiry._TESTSetBuffer(_T("_ntes_quote_callback({\"0600270\": {\"time\": \"2020/04/23 08:30:01\", \"code\": \"0600270\",\"name\":\"don't use chinese character\",\"update\": \"2020/04/23 08:30:01\"} });")); // 要采用网易实时数据制式
