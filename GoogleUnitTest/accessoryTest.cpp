...
namespace StockAnalysisTest {
  ...
  TEST_F(AccessoryTest, TestGetDefaultSchemaAnalysis) {
    ...
    EXPECT_STREQ(GetDefaultSchemaConnect(), _T("DSN=mysqlTest;UID=Test;PASSWORD=test;charset=utf8mb4"));
    EXPECT_TRUE(gl_fTestMode);
    gl_fNormalMode = true;
    EXPECT_STREQ(GetDefaultSchemaConnect(), _T("DSN=mysql;UID=hxguo;PASSWORD=hxguo;charset=utf8mb4"));
