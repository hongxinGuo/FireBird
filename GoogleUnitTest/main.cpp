...
ExcludeFromCodeCoverage(CChinaStock1, L"CChinaStake::AssertValid");
ExcludeFromCodeCoverage(CChinaStock2, L"CChinaStake::Dump");
ExcludeFromCodeCoverage(CChinaStock3, L"CChinaStake::Get1DaysRS");
ExcludeFromCodeCoverage(CChinaStock4, L"CChinaStake::Get3DaysRS");
ExcludeFromCodeCoverage(CChinaStock5, L"CChinaStake::Get5DaysRS");
ExcludeFromCodeCoverage(CChinaStock6, L"CChinaStake::Get10DaysRS");
ExcludeFromCodeCoverage(CChinaStock7, L"CChinaStake::Get30DaysRS");
ExcludeFromCodeCoverage(CChinaStock8, L"CChinaStake::Get60DaysRS");
ExcludeFromCodeCoverage(CChinaStock9, L"CChinaStake::Get120DaysRS");
ExcludeFromCodeCoverage(CChinaStock10, L"CChinaStake::GetRSIndex1Day");
ExcludeFromCodeCoverage(CChinaStock11, L"CChinaStake::GetRSLogarithm1Day");
ExcludeFromCodeCoverage(CChinaStock12, L"CChinaStake::ReportGuadan");
ExcludeFromCodeCoverage(CChinaStock14, L"CChinaStake::ShowDayLine");
ExcludeFromCodeCoverage(CChinaStock15, L"CChinaStake::Calculate10RSStrong1StockSet");
ExcludeFromCodeCoverage(CChinaStock16, L"CChinaStake::Calculate10RSStrong2StockSet");
ExcludeFromCodeCoverage(CChinaStock17, L"CChinaStake::Calculate10RSStrongStockSet");
