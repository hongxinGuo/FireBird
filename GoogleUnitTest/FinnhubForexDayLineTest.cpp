...
namespace FireBirdTest {
	...
	TEST_F(CFinnhubForexDayLineTest, TestInitialize) {
		...
		EXPECT_TRUE(forexDayLine.GetInquiryFunction()== "https://finnhub.io/api/v1/forex/candle?symbol=");
	}
	...
	Test_FinnhubWebData finnhubForexCandle61(1, "OANDA:EUR_ZAR", R"("c":[1.10159,1.10784],"h":[1.10278,1.10889],"l":[1.09806,1.10023],"o":[1.10051,1.10228],"s":"ok","t":[1574978400,1575237600],"v":[36521,47505]})");
	// 没有s项
	Test_FinnhubWebData finnhubForexCandle62_1(11, "OANDA:XAU_SGD", R"({"c":[1.10159,1.10784],"h":[1.10278,1.10889],"l":[1.09806,1.10023],"o":[1.10051,1.10228],"a":"ok","t":[1574978400,1575237600],"v":[36521,47505]})");
	// s项报告非ok
	Test_FinnhubWebData finnhubForexCandle62(2, "OANDA:EUR_ZAR", R"({"c":[1.10159,1.10784],"h":[1.10278,1.10889],"l":[1.09806,1.10023],"o":[1.10051,1.10228],"s":"not ok","t":[1574978400,1575237600],"v":[36521,47505]})");
	// s项报告no data
	Test_FinnhubWebData finnhubForexCandle63(3, "OANDA:EUR_ZAR", R"({"c":[1.10159,1.10784],"h":[1.10278,1.10889],"l":[1.09806,1.10023],"o":[1.10051,1.10228],"s":"no_data","a":[1574978400,1575237600],"v":[36521,47505]})");
	// 数据缺乏t项
	Test_FinnhubWebData finnhubForexCandle64(4, "OANDA:EUR_ZAR", R"({"c":[1.10159,1.10784],"h":[1.10278,1.10889],"l":[1.09806,1.10023],"o":[1.10051,1.10228],"s":"ok","a":[1574978400,1575237600],"v":[36521,47505]})");
	// 缺乏c项。不影响结果
	Test_FinnhubWebData finnhubForexCandle65(5, "OANDA:EUR_ZAR", R"({"a":[1.10159,1.10784],"h":[1.10278,1.10889],"l":[1.09806,1.10023],"o":[1.10051,1.10228],"s":"ok","t":[1574978400,1575237600],"v":[36521,47505]})");
	// 缺乏h项
	Test_FinnhubWebData finnhubForexCandle66(6, "OANDA:EUR_ZAR", R"({"c":[1.10159,1.10784],"a":[1.10278,1.10889],"l":[1.09806,1.10023],"o":[1.10051,1.10228],"s":"ok","t":[1574978400,1575237600],"v":[36521,47505]})");
	// 缺乏l项
	Test_FinnhubWebData finnhubForexCandle67(7, "OANDA:XAU_SGD", R"({"c":[1.10159,1.10784],"h":[1.10278,1.10889],"a":[1.09806,1.10023],"o":[1.10051,1.10228],"s":"ok","t":[1574978400,1575237600],"v":[36521,47505]})");
	// 缺乏o项
	Test_FinnhubWebData finnhubForexCandle68(8, "OANDA:XAU_SGD", R"({"c":[1.10159,1.10784],"h":[1.10278,1.10889],"l":[1.09806,1.10023],"a":[1.10051,1.10228],"s":"ok","t":[1574978400,1575237600],"v":[36521,47505]})");
	// 缺乏v项
	Test_FinnhubWebData finnhubForexCandle69(9, "OANDA:XAU_SGD", R"({"c":[1.10159,1.10784],"h":[1.10278,1.10889],"l":[1.09806,1.10023],"o":[1.10051,1.10228],"s":"ok","t":[1574978400,1575237600],"a":[36521,47505]})");
	// 正确的数据
	Test_FinnhubWebData finnhubForexCandle70(10, "OANDA:XAU_SGD", R"({"c":[1.10159,1.10784],"h":[1.10278,1.10889],"l":[1.09806,1.10023],"o":[1.10051,1.10228],"s":"ok","t":[1575237600, 1574978400],"v":[36521,47505]})");
