...
namespace StockAnalysisTest {
  ...
  TEST_F(CChinaStockTest, TestCalculateHighLowLimit1) {
    CWebRTDataPtr pData = make_shared<CWebRTData>();
    ...
    EXPECT_EQ(stock.GetLowLimit2(), 80);
  ...
  TEST_F(CChinaStockTest, TestCalculateHighLowLimit3) {
    ...
    stock.CalculateHighLowLimit(pData);
    EXPECT_EQ(stock.GetLowLimit2(), 9140);
  ...
  TEST_F(CChinaStockTest, TestCalculateHighLowLimit5) {
    CWebRTDataPtr pData = make_shared<CWebRTData>();
    pData->SetLastClose(14190);
    pData->SetPBuy(0, 0);
    pData->SetPSell(0, 12770);
    CChinaStock stock;
    stock.SetHighLimit(15610);
    stock.SetLowLimit(12770);
    stock.CalculateHighLowLimit(pData);
    EXPECT_EQ(stock.GetLowLimit2(), 12770);
    EXPECT_EQ(stock.GetHighLimit2(), 15610);
  }

  TEST_F(CChinaStockTest, TestCalculateHighLowLimit6) {
    CWebRTDataPtr pData = make_shared<CWebRTData>();
    pData->SetLastClose(5420);
    pData->SetPBuy(0, 5690);
    pData->SetPSell(0, 0);
    CChinaStock stock;
    stock.SetHighLimit(5690);
    stock.SetLowLimit(5150);
    stock.CalculateHighLowLimit(pData);
    EXPECT_EQ(stock.GetLowLimit2(), 5150);
    EXPECT_EQ(stock.GetHighLimit2(), 5690);
  }

  TEST_F(CChinaStockTest, TestCalculateHighLowLimit7) {
    CWebRTDataPtr pData = make_shared<CWebRTData>();
    pData->SetLastClose(23450);
    pData->SetPBuy(0, 0);
    pData->SetPSell(0, 21110);
    CChinaStock stock;
    stock.SetHighLimit(25800);
    stock.SetLowLimit(21110);
    stock.CalculateHighLowLimit(pData);
    EXPECT_EQ(stock.GetLowLimit2(), 21110);
    EXPECT_EQ(stock.GetHighLimit2(), 25800);
  }

  TEST_F(CChinaStockTest, TestCalculateHighLowLimit8) {
    CWebRTDataPtr pData = make_shared<CWebRTData>();
    pData->SetLastClose(23740);
    pData->SetPBuy(0, 26110);
    pData->SetPSell(0, 0);
    CChinaStock stock;
    stock.SetHighLimit(26110);
    stock.SetLowLimit(21370);
    stock.CalculateHighLowLimit(pData);
    EXPECT_EQ(stock.GetLowLimit2(), 21370);
    EXPECT_EQ(stock.GetHighLimit2(), 26110);
  }

  TEST_F(CChinaStockTest, TestCalculateHighLowLimit9) {
    CWebRTDataPtr pData = make_shared<CWebRTData>();
    pData->SetLastClose(2950);
    pData->SetPBuy(0, 3250);
    pData->SetPSell(0, 0);
    CChinaStock stock;
    stock.SetHighLimit(3250);
    stock.SetLowLimit(2660);
    stock.CalculateHighLowLimit(pData);
    EXPECT_EQ(stock.GetLowLimit2(), 2660);
    EXPECT_EQ(stock.GetHighLimit2(), 3250);
  }

  TEST_F(CChinaStockTest, TestCalculateHighLowLimit10) {
    CWebRTDataPtr pData = make_shared<CWebRTData>();
    pData->SetLastClose(2250);
    pData->SetPBuy(0, 0);
    pData->SetPSell(0, 2030);
    CChinaStock stock;
    stock.SetHighLimit(2480);
    stock.SetLowLimit(2030);
    stock.CalculateHighLowLimit(pData);
    EXPECT_EQ(stock.GetLowLimit2(), 2030);
    EXPECT_EQ(stock.GetHighLimit2(), 2480);
  }

  TEST_F(CChinaStockTest, TestCalculateHighLowLimit11) {
    CWebRTDataPtr pData = make_shared<CWebRTData>();
    pData->SetLastClose(86340);
    pData->SetPBuy(0, 94970);
    pData->SetPSell(0, 0);
    CChinaStock stock;
    stock.SetHighLimit(94970);
    stock.SetLowLimit(77710);
    stock.CalculateHighLowLimit(pData);
    EXPECT_EQ(stock.GetLowLimit2(), 77710);
    EXPECT_EQ(stock.GetHighLimit2(), 94970);
  }

  TEST_F(CChinaStockTest, TestCalculateHighLowLimit12) {
    CWebRTDataPtr pData = make_shared<CWebRTData>();
    pData->SetLastClose(85240);
    pData->SetPBuy(0, 93760);
    pData->SetPSell(0, 0);
    CChinaStock stock;
    stock.SetHighLimit(93760);
    stock.SetLowLimit(76720);
    stock.CalculateHighLowLimit(pData);
    EXPECT_EQ(stock.GetLowLimit2(), 76720);
    EXPECT_EQ(stock.GetHighLimit2(), 93760);
  }

  TEST_F(CChinaStockTest, TestCalculateHighLowLimit20) {
    CWebRTDataPtr pData = make_shared<CWebRTData>();
    pData->SetLastClose(25150);
    pData->SetPBuy(0, 0);
    pData->SetPSell(0, 22640);
    ...
    stock.SetLowLimit(0);
    stock.CalculateHighLowLimit(pData);
    EXPECT_EQ(stock.GetLowLimit(), stock.GetLowLimit2()) << _T("与LowLimit2值一样");;
    EXPECT_EQ(stock.GetHighLimit(), stock.GetHighLimit2()) << _T("与HighLimit2值一样");;
  }
