...
namespace FireBirdTest {
	...
	TEST_P(ParseFinnhubSECFilingsTest, TestParseFinnhubSECFilings2) {
		...
		case 10:
			...
			EXPECT_EQ(pvSECFilings->at(0)->m_iAcceptedDate, 1713205871 - gl_pWorldMarket->GetMarketTimeZoneOffset().count());
			EXPECT_EQ(pvSECFilings->at(0)->m_iFiledDate, 1713139200 - gl_pWorldMarket->GetMarketTimeZoneOffset().count());
