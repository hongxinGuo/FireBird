...
namespace FireBirdTest {
	...
	TEST_F(CProductTiingoFinancialStateTest, TestInitialize) {
		...
		EXPECT_EQ(financialState.GetInquiryFunction(), "https://api.tiingo.com/tiingo/fundamentals");
	}
	...
	TEST_P(ParseTiingoFinancialStateTest, TestParseFinancialState) {
		m_pvFinancialState = m_tiingoFinancialStateProduct.Parse(m_text);
		switch (m_index) {
		case 1: // 格式不对
