...
auto s_simdjson1 = R"({
	...
	"string2" : null,
	"array2" : null,
	"DataArray3" :[ {	"integer": 1,	"double" : 2.0,	"string" : "string1",	"array" : [ 1, 2, 3]},
									{	"integer" : null,	"double" : null, "string" : null,	"array" : null}
								],
	"DataArray4" : [ 1, 2.0, "string2",null, null, null]
	})"_padded;
...
namespace FireBirdTest {
	...
	auto s_simdjson2 = R"({ 
		"item1" : { "a" : 1, "b" : 2.0, "c" : "string1"},
		"item2" : { "a" : 2, "b" : 4.0, "c" : "string2"} 
	})"_padded;
