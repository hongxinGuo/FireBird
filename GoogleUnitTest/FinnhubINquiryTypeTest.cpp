...
namespace FireBirdTest {
	TEST(FinnhubInquiryTypeTest, Test) {
		...
		EXPECT_EQ(COMPANY_PROFILE_, STOCK_SYMBOLS_ + 1);
		EXPECT_EQ(COMPANY_PROFILE_CONCISE_, COMPANY_PROFILE_ + 1);
		EXPECT_EQ(COMPANY_EXECTIVE_, COMPANY_PROFILE_CONCISE_ + 1);
		EXPECT_EQ(MARKET_NEWS_, COMPANY_EXECTIVE_ + 1);
		...
		EXPECT_EQ(ALTERNATIVE_DATA_COVID_19_, ALTERNATIVE_DATA_VISA_APPLICATION_ + 1);
