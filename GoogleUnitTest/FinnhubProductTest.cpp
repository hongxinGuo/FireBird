...
namespace StockAnalysisTest {
	...
	TEST_F(CFinnhubProductTest, TestAddInaccessibleExchange) {
		...
		CInaccessibleExchangesPtr pExchange = gl_finnhubInaccessibleExchange.GetInaccessibleExchange(__STOCK_SYMBOLS__);
		...
		pExchange = gl_finnhubInaccessibleExchange.GetInaccessibleExchange(__STOCK_SYMBOLS__);
