...
namespace FireBirdTest {
	...
	protected:
		...
		void SetUp(void) override {
			...
			SinaRTWebInquiry.SetInquiringWebData(true);
		}
	...
	TEST_F(CThreadReadSinaRTDataTest, TestThreadReadSinaRTData) {
		...
		SinaRTWebInquiry.TESTSetBuffer(_T("testData"));
