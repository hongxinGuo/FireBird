...
namespace testing {
  ...
  public:
    ...
    MOCK_METHOD(bool, RunningThreadSaveStakeCode, (), (override));
    MOCK_METHOD(bool, RunningThreadSaveSectionIndex, (), (override));
    ...
    MOCK_METHOD(bool, SaveStakeCode, (), (override));
    MOCK_METHOD(bool, SaveSectionIndex, (), (override));
