...
namespace FireBirdTest {
	...
	TEST_F(jsonParseTest, TestIsVoidJson) {
		string s = "{}";
		EXPECT_TRUE(IsVoidJson(s));
		string s2 = "[]";
		EXPECT_TRUE(IsVoidJson(s2));
		string s3 = "{[]}";
		EXPECT_FALSE(IsVoidJson(s3));

		string_view sw = "{}";
		EXPECT_TRUE(IsVoidJson(sw));
		string_view sw2 = "[]";
		EXPECT_TRUE(IsVoidJson(sw2));
		string_view sw3 = "{[]}";
		EXPECT_FALSE(IsVoidJson(sw3));
	}
